...
## Performance Metrics
- **Verification snapshot (pytest hygiene)**: 2026-05-01 — last recorded full suite ~162 passed, ~15 skipped (`python -m pytest agent/tests deploy/tests -q`; counts drift—re-run to refresh).
