...
| `NFR-observability-coverage` / `NFR-observability-minimum-questions` (scaffold) | `agent/tests/unit/test_events.py`, `agent/tests/unit/test_observability_log_minimum_questions.py`, `agent/tests/integration/test_http_logging_observability.py`, `agent/tests/integration/test_openemr_base_url_misconfiguration.py` |
