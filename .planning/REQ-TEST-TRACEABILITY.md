...
| `REQ-deployment-smoke-suite` | `deploy/tests/integration/test_deployment.py` (live URL, gated), `deploy/tests/test_fly_manifest_offline.py` (offline manifest checks), `deploy/docs/deployment.md` |
