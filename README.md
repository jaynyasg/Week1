...
```
cd existing_repo
git remote add origin https://labs.gauntletai.com/jaygodfrey/Week1.git
git branch -M main
...
* [Set up project integrations](https://labs.gauntletai.com/jaygodfrey/Week1/-/settings/integrations)
