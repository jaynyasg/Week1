...
| Evaluation | **~163** automated tests passing offline (`agent/tests`, `deploy/tests`); live OpenEMR gated by env. Snapshot: [`.planning/eval-artifacts/2026-05-01-submission-prep-snapshot.md`](.planning/eval-artifacts/2026-05-01-submission-prep-snapshot.md). | Low |
